...
const FeaturedProductCarousel = ({
  ...
  return (
    <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black py-6 overflow-hidden">
      {/* Background effects */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-4">
          <h2 className="text-xl md:text-2xl font-bold text-white mb-2 electric-lime-glow">
            FEATURED PRODUCTS
          </h2>
            ...
            <div className="relative bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50 hover:border-primary/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-primary/20 overflow-hidden group">
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 relative z-10">
                ...
                <div className="w-full md:w-1/2 flex flex-col text-center md:text-left">
                  ...
                  <Button asChild className="bg-gradient-to-r from-primary to-green-400 hover:from-green-400 hover:to-primary text-black font-bold py-2 px-4 rounded-full shadow-lg hover:shadow-primary/50 transition-all duration-300 hover:scale-105 w-full md:w-auto max-w-xs mx-auto md:mx-0">
