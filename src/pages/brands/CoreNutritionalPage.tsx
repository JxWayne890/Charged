  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        ...
        toast({
          title: "Error",
          description: "Failed to load Core Nutritionals products",
          variant: "destructive",
        });
      } finally {
        setLoading(false);
    ...
    <div className="container mx-auto px-4 py-8 mt-20">
      ...
      {products.length > 0 ? (
        ...
        <div className="text-center py-12">
          <p className="text-gray-600 text-lg">No Core Nutritionals products available at the moment. Check back soon!</p>
        </div>
      )}
    </div>
  );
...
export default CoreNutritionalPage;
